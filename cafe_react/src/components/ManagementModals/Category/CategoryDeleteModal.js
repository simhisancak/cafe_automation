                ...
                <div className="w-full max-w-lg p-5 relative mx-auto my-auto rounded-xl bg-gray-600 flex justify-center z-10">
                    ...
                    <div className="mt-10 management_delete">
                        <div className="mb-5">
                            ...
                            <label> İsimli kategoriyi gerçekten silmek istiyor musunuz?</label>
                        </div>
                        <div className="flex justify-between" >
                            <button disabled={ModalLoading} className="py-2 px-7 bg-red-900 rounded-sm" onClick={()=> props.DeleteCategory(setModalLoading)}>Evet</button>
