...
function UserAddModal (props){
    ...
    function form_submit(e){
        e.preventDefault()
        props.AddUser(user_name, password, mail, super_user, setModalLoading)
    }
                    ...
                    <form className="management_form" onSubmit={onsubmit}>
                        ...
                        <ul>
                            ...
                            <li className="flex justify-start items-center">
                                <input className="management_checkbox" type="checkbox" id="super_user_add" checked={super_user || false} onChange={(e) => setsuper_user(e.target.checked)}/>
                                <label htmlFor="super_user_add" className="ml-2">Yönetici</label>
                            </li>
                            <li>
